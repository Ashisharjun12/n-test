...
export default function AddCompanySheet({ open, onClose }) {
  const user       = useAuthStore((s) => s.user)
  const { addCompany, isLoading, error, clearError } = useCompanyStore()
    ...
    <Sheet open={open} onOpenChange={onClose}>
      ...
      >
        ...
        <div className="px-5 pt-3 pb-4 border-b border-[#dee1e6]">
          <p className="text-[18px] font-semibold text-[#0a0b0d]">Add Company</p>
          <p className="text-[13px] text-[#7c828a] mt-0.5">Fill your business details</p>
        </div>
